...
To begin this analysis, we decided to leverage an existing dataset consisting of ~600k tracks from 1922-2021 that was created from the Spotify Web API. The data is divided into various perspectives. For our purpose, we chose to analyze Popularity in reference to Tracks, Artists and Genres.
